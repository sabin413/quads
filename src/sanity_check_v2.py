...
# now try to get access of historical tdigest for the data of given stratum -- then do the computation
# save it to a mysql database - 1 day
# then think about how am I gonna store the historical results - 1 day
